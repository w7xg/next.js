...
export default function () {
  return (
    <Layout>
	  ...
	  <Card shadow>
	  <Text h4>
	  <center><iframe src="//player.bilibili.com/player.html?aid=554745&bvid=BV1Cs411Z7hm&cid=825847&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="500" height="400"> </iframe></center>
	  <Spacer y={2}/>
